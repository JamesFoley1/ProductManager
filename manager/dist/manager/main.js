...
module.exports = "<head>\n    <link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0-rc.2/css/materialize.min.css\">\n    <script src=\"https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0-rc.2/js/materialize.min.js\"></script>\n</head>\n<nav>\n  <div class=\"nav-wrapper\">\n    <a [routerLink]=\"['']\" class=\"brand-logo\">PDD - Project Doomsday</a>\n    <ul id=\"nav-mobile\" class=\"right hide-on-med-and-down\">\n      <li><a [routerLink]=\"['']\">Home</a></li>\n      <li><a [routerLink]=\"['/products']\">Product List</a></li>\n      <li><a [routerLink]=\"['/products/new']\">Product Creation</a></li>\n    </ul>\n  </div>\n</nav>\n\n<router-outlet></router-outlet>\n"
...
module.exports = "<div class=\"row\">\n  <div class=\"col s12 m6 offset-m3 l6 offset-l3\">\n    <div class=\"card\">\n      <form class=\"card-content\" [formGroup]=\"update\" (ngSubmit)=\"updateProduct(update.value)\">\n        <h5>Update This Product</h5>\n        <label>Title</label><input type=\"text\" formControlName=\"title\" [ngModel]=\"product.title\">\n        <label>Price</label><input type=\"text\" formControlName=\"price\" [ngModel]=\"this.product.price\">\n        <label>Image URL</label><input type=\"text\" formControlName=\"url\" [ngModel]=\"this.product.url\">\n        <input type=\"hidden\" formControlName=\"_id\" [ngModel]=\"id\">\n        <input class=\"btn\" type=\"submit\" name=\"submit\" value=\"Update\" [disabled]=\"!update.valid\">\n        <a class=\"btn\" [routerLink]=\"['/products']\">Cancel</a>\n    </form>\n    </div>\n  </div>\n</div>"
...
var EditComponent = /** @class */ (function () {
    function EditComponent(_httpService, fb, _route, _router, _parent) {
        var _this = this;
        this._httpService = _httpService;
        this.fb = fb;
        this._route = _route;
    ...
    EditComponent.prototype.getProduct = function (id) {
        var _this = this;
        var product = this._httpService.oneProduct(id);
    ...
    EditComponent.prototype.updateProduct = function (data) {
        var _this = this;
        console.log(data);
        var updateProduct = this._httpService.updateProduct(data);
        updateProduct.subscribe(function (data) {
            console.log(data);
    ...
    EditComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_http_service__WEBPACK_IMPORTED_MODULE_1__["HttpService"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _node_modules_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _node_modules_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _products_products_component__WEBPACK_IMPORTED_MODULE_4__["ProductsComponent"]])
    ], EditComponent);
...
module.exports = "<div class=\"row\">\n  <div class=\"col s12 m6 offset-m3 l6 offset-l3\">\n    <div class=\"card\">\n      <div class=\"card-content\">\n        <p>Welcome to Project Doomsday! Home to all of your doomsday devices! Have you ever wanted to end the world, on a budget?! Come on down to Project Doomsday now!</p>\n      </div>\n    </div>\n  </div>\n</div>"
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.allProducts = function () {
        return this._http.get('/api/products');
    };
    ;
    HttpService.prototype.oneProduct = function (id) {
        return this._http.get('/api/products/' + id);
    };
    ;
    HttpService.prototype.newProduct = function (data) {
        return this._http.post('/api/products/new', data);
    };
    ;
    HttpService.prototype.updateProduct = function (data) {
...
module.exports = "<div class=\"row\">\n  <div class=\"col s12 m6 offset-m3 l6 offset-l3\">\n    <div class=\"card\">\n      <form class=\"card-content\" [formGroup]=\"create\" (ngSubmit)=\"newProduct(create.value)\">\n        <h5>Create a New Product</h5>\n        <label>Title</label><input type=\"text\" formControlName=\"title\">\n        <label>Price</label><input type=\"text\" formControlName=\"price\">\n        <label>Image URL</label><input type=\"text\" formControlName=\"url\">\n        <input class=\"btn\" type=\"submit\" name=\"submit\" value=\"Submit\" [disabled]=\"!create.valid\">\n        <a class=\"btn\" [routerLink]=\"['/products']\">Cancel</a>\n    </form>\n    </div>\n  </div>\n</div>"
...
var NewComponent = /** @class */ (function () {
    function NewComponent(_httpService, fb, _route, _router) {
        this._httpService = _httpService;
        this.fb = fb;
        this._route = _route;
        this._router = _router;
    ...
    NewComponent.prototype.newProduct = function (post) {
        var _this = this;
        var new_product = this._httpService.newProduct(post);
        new_product.subscribe(function (data) {
            console.log(data);
    ...
    NewComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_http_service__WEBPACK_IMPORTED_MODULE_1__["HttpService"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"], _node_modules_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"], _node_modules_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], NewComponent);
    return NewComponent;
}());
...
module.exports = "<p class=\"center\">Sorry the url you requested could not be found!</p>\n"
...
module.exports = "<div class=\"row\">\n  <div class=\"col s12 m6 offset-m3 l6 offset-l3 scrolling-wrapper\">\n    <div class=\"card\" *ngFor=\"let i of products\">\n      <div class=\"card-content\">\n        <label>{{ i.title }}</label><br>\n        <img src=\"{{ i.url }}\" alt=\"doomsday device\"><br>\n        <label>Price: ${{ i.price }}</label>\n      </div>\n      <div class=\"card-action\">\n        <a [routerLink]=\"['edit/', i._id]\">Edit</a>\n        <a (click)=\"destroy(i._id)\">Delete</a>\n      </div>\n    </div>\n  </div>\n</div>\n\n<router-outlet></router-outlet>\n"
...
var ProductsComponent = /** @class */ (function () {
    ...
    ProductsComponent.prototype.getProducts = function () {
        var _this = this;
        this.products = [];
        var allProducts = this._httpService.allProducts();
        allProducts.subscribe(function (data) {
            for (var i in data) {
    ...
    ;
    ProductsComponent.prototype.destroy = function (id) {
        var _this = this;
        var destroy = this._httpService.removeProduct(id);
        destroy.subscribe(function (data) {
            console.log(data);
            _this.getProducts();
        });
    };
...
module.exports = __webpack_require__(/*! /Users/PickleRick/Desktop/CD_MEAN/angular/product_manager/manager/src/main.ts */"./src/main.ts");
